 ...
 <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="about-globo">
              ...
              <div class="footer-logo">
                ...
                <span><h1 style="font-size: 47px;">Topline</h1></span> <!-- This content for overlay effect -->
              </div>
          ...
          <div class="col-md-3 col-sm-6 clearfix">
            <div class="popular-categories">
              ...
              <ul>
                <li><a href="#"><i class="fa fa-cutlery" aria-hidden="true"></i>Restaurent</a></li>
                <li><a href="#"><i class="fa fa-car" aria-hidden="true"></i>Transport</a></li>
                <li><a href="#"><i class="fa fa-shopping-cart"></i>Grocery</a></li>
                <li><a href="#"><i class="fa fa-book"></i>Libraries &amp; Book's</a></li>
    ...
    <div class="copyright">
      <div class="container">
        <p>Copyright 2019-20 &copy; Topline. All rights reserved. Powered by  <a href="#">symex IT</a></p>
  ...
  <script>
import ToplineFooter from "./ToplineFooter";
export default {
    components: { 
        ToplineFooter
    }
