            ...
            <div class="page-sidebar">
              <div class="categories" >
                <div class="ac">
                  ...
                  <li v-for="(serv, index) in service">
                    <a  href="search-result.html"><i :class="serv.icon" aria-hidden="true"></i>  {{ serv.name }}</a>
                    </li>
                    </ul>
                </div>
            </div>
      ...
      <div class="row clearfix">
        ...
        <div class="col-md-3 col-sm-4 col-xs-6">
          ...
          <div class="single-product">
            ...
            <h5><a href="#">Store</a>, <a href="#">Faydabad, Dhaka 1230</a></h5>
