@extends('vendor.app')
@section('content')
<form enctype="multipart/form-data" action="{{url('/hospital_info/update')}}" method="post">
          @csrf
            <div class="modal-body">
                <div class="row">
           <input class="form-control vendorname" type="hidden" value="{{$data->id}}" name="id">
                    <div class="col-sm-4 form-group">
                        <label for="Max Value">Hospital Name</label>
          ...
          <img src="{{asset($data->vendor_logo)}}" height="60px" width="100px">
                ...
                <div class="col-sm-3 form-group">
                    <label for="Max Value">Slider (1850 X 450)</label>
                ...
                <div class="col-sm-4 form-group">
                    <label for="Max Value">Hospital Special</label>
