            ...
            <div class="tab-content">
              ...
              <h2>{{$profile->vendor_name}}</h2>
                ...
                <div class="company-service">
                  ...
                  <li><a href="#">{{$ser->service_name}}</a></li>
                 @endforeach
                  </ul>
                  ...
                  <div class="rating-with-details">
                    ...
                    <div class="single-content">
                      <div class="company-rating-box" style="height:120px;width:120px;">
                          <img src="{{asset($doctor->image)}}" width="100%" height="100%">
                      </div>
                      <div class="rating-details">
                        ...
                        <p>{{$doctor->qualification}}</p>
                          <p><b>Specialities</b> : {{$doctor->speciality}} </p>
                          <p>Time : <b>{{$doctor->time}}</b> 
                              @if($doctor->onday=='')
                              @else
                            <span style="color:green;">( {{$doctor->onday}})</span>
                            @endif
                            @if($doctor->offday=='')
                        
                            @else
                            <span style="color:red;">( {{$doctor->offday}} Off )</span> 
                            @endif
                          
                          
                          </p>
                        <p>Doctor in Chamber : @if($doctor->chamber==1) <b>Available</b> @else <b>Not Available</b> @endif </p>                           
                       </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="address-details clearfix">
                        ...
                        <p>
                          <span><strong>{{$profile->openday}}:</strong>{{$profile->opentime}}</span>
                          <span><strong>{{$profile->closeday}}</strong> {{$profile->closetime}}</span>
                        </p>
                      </div>
